...
htmlhelp_basename = 'LOBIinhouseresourcesdoc'
...
man_pages = [
    (master_doc, 'lobiinhouseresources', 'LOBI inhouse resources Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'LOBIinhouseresources', 'LOBI inhouse resources Documentation',
     author, 'LOBIinhouseresources', 'One line description of project.',
     'Miscellaneous'),
]
